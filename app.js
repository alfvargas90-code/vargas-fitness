...
async function renderRings() {
  ...
  try {
    ...
    if (moonCtxHero && lunar?.lunar) {
      ...
      if (nsc && L.sign) {
        rows.push(`<div class="text-[10px] font-semibold tracking-wide mt-1" style="color:#B6A0FF;text-shadow:0 0 2px rgba(3,5,15,0.92),0 1px 6px rgba(3,5,15,0.8)">Leaves ${L.sign}</div>`);
